...
final_message = (
    ""  # Menampung kalimat konversi (hasil kode morse yang telah diinput: "AK")
)
...
def update_terminal_display():
    """
    Fungsi ajaib untuk menghapus baris terminal saat ini dan mencetak ulang
    gabungan kalimat utama, kode Morse aktif, dan cursor '|' di ujungnya.
    """
    # \r mengembalikan kursor ke awal baris, end="" mencegah terminal otomatis ganti baris baru
...
print(" . : .-.-.-   , : --..--   ? : uun--..   / : -..-.   : : ---...")
print("=" * 8)
print("\tMesin Kode Morse")
print("=" * 8)
print("Tekan:\n5: Input Kode\n1x 18: Konversi Kode Morse\n2x 18: Spasi\n")

# Cetak tampilan awal cursor statis pertama kali
print("", end="")

time.sleep(2)  # Jeda sinkronisasi sistem
...
while True:
    ...
    # ==========================================
    # LOGIKA 1: MEMBACA TOMBOL UTAMA (KODE MORSE)
    # ==========================================
