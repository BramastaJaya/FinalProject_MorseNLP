...
* **Konfigurasi Jaringan Statis (Hardcoded):** Kredensial Wi-Fi saat ini ditanamkan langsung (hardcoded) di dalam program. Diperlukan pengembangan fitur *Captive Portal* agar pengguna dapat mengganti jaringan Wi-Fi secara fleksibel tanpa harus menulis ulang kode melalui komputer.